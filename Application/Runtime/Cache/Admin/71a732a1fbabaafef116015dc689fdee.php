...
<section class="content-header">
    ...
    <!-- 主体内容 -->
    <form method="post" name="form1" action="<?php echo U('house/house_update_sql');?>" enctype="multipart/form-data">
        <input type="hidden" name="up_id" value="<?php echo I('get.update_id');?>">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo ($data[0]['title']); ?>" name="house_name" placeholder="输入楼盘名称 ..." class="form-control wp50 inline-block" >
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess">楼盘简介：<span class="required">*</span></label>
                                    <input type="text" value="<?php echo ($data[0]['summary']); ?>" name="house_mess" placeholder="输入楼盘简介 ..." class="form-control wp50 inline-block" >
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="lx" class="form-control" style="width: 300px; display: inline">
                                        ...
                                        <?php if($key == $data[0]['property_type']): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($val); ?></option>
                                            <?php else: ?>
                                            <option value="<?php echo ($key); ?>" ><?php echo ($val); ?></option><?php endif; ?>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess">参考价格：<span class="required">*</span></label>
                                    <input type="text" value="<?php echo ($data[0]['price']); ?>" style="width: 90px;" name="house_money" placeholder="输入参考价格..." class="form-control wp50 inline-block" ><span id="mon">元/平米</span>
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess" style="position: relative;top: -130px;">项目特色：</label>
                                    <textarea name="ts" style="width: 400px; height: 150px;"><?php echo ($data[0]['feature']); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="label_mess inline-block">是否热门:</label>
                                    <div id="is_hot" class="inline-block">
                                        <label class="radio-inline"><input type="radio"  class=""  value="1" name="is_hot">是</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="is_recommended" class="inline-block">
                                        <label class="radio-inline"><input type="radio"  class=""  value="1" name="is_recommended">是</label>
                                        <label class="radio-inline"><input type="radio"  class="" value="0" name="is_recommended">否</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-md-2" style="width: 100px; margin-left: 30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="house_adress" value="<?php echo ($data[0]['address']); ?>" type="text" placeholder="输入楼盘地址..." class="form-control wp50 inline-block" >
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess">售楼处地址：</label>
                                    <input name="sl_adress" value="<?php echo ($data[0]['sale_address']); ?>" type="text" placeholder="输入售楼处地址..." class="form-control wp50 inline-block" >
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess">开发商：</label>
                                    <input name="developer" value="<?php echo ($data[0]['builder_company']); ?>" type="text" placeholder="输入开发商..." class="form-control wp50 inline-block" >
                                </div>
                                <div class="form-group">
                                    <label for="" class="label_mess">缩略图：</label>
                                    <div class="input-group" style="position: relative; left: 120px; top: -30px;">
                                        <input type="text" placeholder="上传缩略图 ..." value="<?php echo ($data[0]['thumb']); ?>" style="width: 150px;"  class="form-control" id="uiFileUploadInput1" data-thumb="">
                            ...
                            <div class="tab-pane" id="tab_2">
                                ...
                                <!-- 获取数据库中户型数据-->
                                <?php if(is_array($hx_data)): $i = 0; $__LIST__ = $hx_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="new_div">
                                        <div class="form-group">
                                            <label for="" class="label_mess">户型名称：</label>
                                            <span class="hx"><?php echo ($row["title"]); ?></span>
                                            <input  name="hx[]" type="hidden" value="<?php echo ($row["title"]); ?>">
                                            <span class="hx_del" onmouseover="cc(this)" onmouseout="c1(this)" onclick="c2(this)" style="float: right; cursor: pointer; font-size: 26px; position: relative; top: -10px;">×</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="label_mess">户型朝向：</label>
                                            <span class="hx_cx" ><?php echo ($row["orientation"]); ?></span>
                                            <input  name="hx_cx[]" type="hidden" value="<?php echo ($row["orientation"]); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="label_mess">居室：</label>
                                            <span class="hx_type" ><?php echo ($row["room"]); ?>室<?php echo ($row["hall"]); ?>厅<?php echo ($row["toilet"]); ?>卫</span>
                                            <input  name="hx_type_s[]" value="<?php echo ($row["room"]); ?>" type="hidden">
                                            <input  name="hx_type_t[]" value="<?php echo ($row["hall"]); ?>" type="hidden">
                                            <input  name="hx_type_w[]" value="<?php echo ($row["toilet"]); ?>" type="hidden">
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="label_mess">建筑面积：</label>
                                            <span class="hx_mj" ><?php echo ($row["area"]); ?></span>
                                            <input name="hx_mj[]" type="hidden" value="<?php echo ($row["area"]); ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="" class="label_mess">缩略图：</label>
                                            <img src="<?php echo ($row["thumb"]); ?>" style="width: 23%" class="thumb">
                                            <input type="hidden" name="thumb[]" class="hide_thumb" value="<?php echo ($row["thumb"]); ?>">
                                        </div>
                            ...
                            <div class="tab-pane" id="tab_3">
                                    <div style="display: none;">
                                        <div class="form-group house_img div_11" >
                                            <div class="div_1">
                                    ...
                                    <?php if(is_array($img_arr)): $i = 0; $__LIST__ = $img_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img_row): $mod = ($i % 2 );++$i;?><div class="form-group house_img div_11" >
                                            <div class="div_1">
                                                <?php if($img_row['images'][0] != '' ): ?><img src="<?php echo ($img_row['images'][0]); ?>" class="thumb1" style="width: 150px; height: 150px;"><?php endif; ?>
                                                <?php if($img_row['images'][1] != '' ): ?><img src="<?php echo ($img_row['images'][1]); ?>" class="thumb2" style="width: 150px; height: 150px;"><?php endif; ?>
                                                <?php if($img_row['images'][2] != '' ): ?><img src="<?php echo ($img_row['images'][2]); ?>" class="thumb3" style="width: 150px; height: 150px;"><?php endif; ?>
                                                <?php if($img_row['images'][3] != '' ): ?><img src="<?php echo ($img_row['images'][3]); ?>" class="thumb4" style="width: 150px; height: 150px;"><?php endif; ?>
                                                <?php if($img_row['images'][0] != '' ): ?><input type="hidden"  name="lp_thumb[]"  class="hide_thumb1" value="<?php echo ($img_row['images'][0]); ?>"><?php endif; ?>
                                                <?php if($img_row['images'][1] != '' ): ?><input type="hidden"  name="lp_thumb[]" class="hide_thumb1_1" value="<?php echo ($img_row['images'][1]); ?>"><?php endif; ?>
                                                <?php if($img_row['images'][2] != '' ): ?><input type="hidden"  name="lp_thumb[]" class="hide_thumb1_2" value="<?php echo ($img_row['images'][2]); ?>"><?php endif; ?>
                                                <?php if($img_row['images'][3] != '' ): ?><input type="hidden"  name="lp_thumb[]" class="hide_thumb1_3" value="<?php echo ($img_row['images'][3]); ?>"><?php endif; ?>

                                                <span style="margin-left: 30px; font-size: 18px;" id="lp_text"><?php echo ($img_row['title']); ?></span>
                                                <input type="hidden" name="lp_text[]">
                                                <button type="button" class="btn btn-danger pull-right del " onclick="return yc(this)">移除</button>
                                            </div>
                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div class="tab-pane" id="tab_4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 300px; display: inline" name="jz_type">
                                        ...
                                        <?php if($key == $data[0]['jzlx']): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($val); ?></option>
                                            <?php else: ?>
                                            <option value="<?php echo ($key); ?>" ><?php echo ($val); ?></option><?php endif; ?>
                                            <?php endforeach;?>
                                    </select>
                                    ...
                                    <div style="margin-left: 45px;">
                                        ...
                                        <div class="inline-block">
                                            <div class="input-group">
                                                <input type="text" name="zj" placeholder="输入最新开盘时间 ..." value="<?php echo ($data[0]['open_time']); ?>" id="begin-time" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cq" value="<?php echo ($data[0]['cqnx']); ?>" placeholder="输入产权年限 ..." class="form-control wp50 inline-block" >
                                </div>
                            </div>
                        </div><!-- /.tab-content -->
                    </div>
        ...
        <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label  class="label_mess">添加楼盘相册：</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" style="position: relative; left: 120px; top: -30px;">
                                ...
                                <input type="text" name="image" placeholder="上传缩略图 ..." style="width: 150px;"  class="form-control" id="uiFileUploadInput3" data-thumb="">
...
<script type="text/javascript">
    var is_hot = "<?php echo ($data[0]['is_hot']); ?>";
    $("#is_hot input[value="+is_hot+"]").prop("checked",true);
    var is_recommended = "<?php echo ($data[0]['is_recommended']); ?>";
    $("#is_recommended input[value="+is_recommended+"]").prop("checked",true);
    //选择日期
    ...
    $("#img_yc").click(function (){
        $(".div_11:eq("+parseFloat(yc_id)+")").remove();
        $('#myModall').modal('hide');
    });
    ...
    $("#ok_insert_img").click(function (){
        ...
        $("#inser_img").before($("#tab_3 div:eq(0)").find('div').first().clone(true));
        $("#Modal").modal('hide');
    });

    //提交按钮
    function sumi(){
        var str = $('#uiFileUploadInput1').val();
        $('#jb_image').val(str);
    ...
    //省市区三级联动
    $(function () {
        var province = "<?php echo ($data[0]['province_id']); ?>";
        var city = "<?php echo ($data[0]['city_id']); ?>";
        var district = "<?php echo ($data[0]['district_id']); ?>";
        //省市区三级联动
        //注意三级联动结构：#region(自定义) > .province + .city + .district
        $("#region").citySelect({
            nodata: "none",
            required: false,
            province: province ? province : null, //"河南省"
            city: city ? city : null,
