...
<div id="header">
    <div class="pull-left hide" id="back" style="position:absolute;left: 25px;">
        <a href="javascript:history.go(-1)" class="arrow-back"><i class="icon ion-ios-arrow-back" style="font-size: 35px;color: white"></i></a>
    </div>
    <div class="header_title"><?php echo ($site_title); ?></div>
</div>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="login-logo"><i class="fa fa-street-view"></i>&nbsp;&nbsp;<?php echo ($meta_title); ?></div>

        <hr>
        <p class="login-box-msg"><span style="font-size:18px;">T会员登录</span></p>
        ...
        <form action="<?php echo U('auth/login');?>" method="post" name="loginform" id="myform">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <button type="submit" class="btn bg-purple btn-block btn-flat">登录</button>
