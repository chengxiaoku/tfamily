...
CREATE TABLE `tf_admin_role` (
  ...
  `enabled` enum('0','1') DEFAULT '1' COMMENT '是否启用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tf_house` (
  ...
  `price` varchar(120) DEFAULT NULL COMMENT '均价',
  ...
  `images` varchar(512) DEFAULT NULL COMMENT '相册',
...
CREATE TABLE `tf_house_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号',
  `house_id` int(10) DEFAULT NULL COMMENT '房屋id',
  `title` varchar(10) DEFAULT NULL COMMENT '户型名',
  `status` enum('no','pending','yes') DEFAULT NULL COMMENT '在售状态',
  `content` text COMMENT '户型描述',
...
CREATE TABLE `tf_level` (
  ...
  `teams` varchar(255) DEFAULT NULL COMMENT '等级晋升标准',
  `year_salary` decimal(10,2) DEFAULT NULL,
  `award_fans` decimal(10,2) DEFAULT NULL,
  `award_direct` decimal(10,2) DEFAULT NULL,
  `award_team` decimal(10,2) DEFAULT NULL,
  `award_year` decimal(10,2) DEFAULT NULL,
  `award_integral` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tf_money_details` (
  ...
  `do_type` enum('cash','integral','award') DEFAULT NULL COMMENT '资金类型',
...
CREATE TABLE `tf_notices` (
  ...
  `type` enum('all','one') DEFAULT NULL COMMENT '消息类型',
  `add_time` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tf_team` (
  ...
  `status` enum('no','yes') DEFAULT NULL COMMENT '状态',
  `add_time` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tf_user` (
  ...
  `status` enum('disabled','enabled') DEFAULT 'enabled' COMMENT '用户状态',
  `is_validated` enum('no','yes') DEFAULT NULL COMMENT '是否实名认证',
  ...
  `month_end` datetime DEFAULT NULL   COMMENT '送粉丝位结束时间',
